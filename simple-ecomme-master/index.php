    ...
    <div class="container">
      <div class="row">
       ...
       <div class="col-sm-3 col-xs-6 text-center">
        	<a href="store.php?category=13"><img src="img/home-shopmac.png" alt="Shop Mac"></a>
        </div>
        <div class="col-sm-3 col-xs-6 text-center">
        	<a href="store.php?category=14"><img src="img/home-shopiphone.png" alt="Shop iPhone"></a>
        </div>
        <div class="col-sm-3 col-xs-6 text-center">
        	<a href="store.php?category=19"><img src="img/home-shopipad.png" alt="Shop iPad"></a>
        </div>
        <div class="col-sm-3 col-xs-6 text-center">
        	<a href="store.php?category=20"><img src="img/home-shopipod.png" alt="Shop iPod"></a>
        </div>
      </div>
    </div>
</div>
